...
main(int argc, char **argv) {
    ...
    ui_print("CWM modding by Simone201\n\n");
    load_volume_table();
    process_volumes();
    ...
    if((test2=opendir("/sdcard/clockworkmod"))==NULL)
		__system("mkdir /sdcard/clockworkmod");
	closedir(test2);
    
    if(((test=fopen("/sdcard/clockworkmod/.salted_hash", "r"))==NULL)||((test=fopen("/sdcard/clockworkmod/.one_confirm", "r"))==NULL))
	{
