...
void show_governors_menu()
{
	FILE *test;
	
	static char* scelta[] = { "*** YES ***",
                              "*** NO ***",
                              NULL
							};
	
	static char* headers[] = { "N.E.A.K. Governors Menu",
                                "",
                                NULL
							 };
	static char* list[] = { "Enable/Disable Conservative GOV",
                            "Enable/Disable Lazy GOV",
                            "Enable/Disable LionHeart Tweaks",
                              NULL
						  };
	...
	for (;;)
	{
		...
		switch (chosen_item)
		{
			case 0:
			{
				if((test=fopen("/data/neak/conservative", "r"))==NULL)
				{
					static char* titolo1[] = { "Do you want to enable Conservative GOV?",
											   "",
											   NULL
											 };
					int scelto = get_menu_selection(titolo1, scelta, 0, 0);
					if(scelto == GO_BACK)
						break;
					switch(scelto)
					{
			...
			{
				static char* titolo2[] = { "Do you want to disable Conservative GOV?",
										   "",
										   NULL
										 };
				int scelto = get_menu_selection(titolo2, scelta, 0, 0);
				if(scelto == GO_BACK)
					break;
				switch(scelto)
				{
		 ...
		 case 1:
		 {
			if((test=fopen("/data/neak/lazy", "r"))==NULL)
			{
				static char* titolo1[] = { "Do you want to enable Lazy GOV?",
											"",
											NULL
										 };
				int scelto = get_menu_selection(titolo1, scelta, 0, 0);
			...
			{
				static char* titolo2[] = { "Do you want to disable Lazy GOV?",
											"",
										NULL
										 };
				int scelto = get_menu_selection(titolo2, scelta, 0, 0);
		 ...
		 case 2:
		 {
			...
			{
				if((test=fopen("/data/neak/lionheart", "r"))==NULL)
				{
					static char* titolo1[] = { "Do you want to enable Lionheart Tweaks?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo1, scelta, 0, 0);
				...
				{
					static char* titolo2[] = { "Do you want to disable Lionheart Tweaks?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo2, scelta, 0, 0);
...
void show_misc_menu()
{
	...
	static char* headers[] = { "N.E.A.K. Misc Options Menu",
                                "",
                                NULL
							 };

	static char* list[] = { "Enable/Disable sched_mc power savings",
							"Enable/Disable AFTR Idle Mode",
							"Enable/Disable EXT4 Boost Tweaks",
							NULL
						  };
	...
	for (;;)
	{
		...
		switch (chosen_item)
		{
			case 0:
			{
				if((test=fopen("/data/neak/schedmc", "r"))==NULL)
				{
					static char* titolo1[] = { "Do you want to enable SCHED_MC?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo1, scelta, 0, 0);
				...
				{
					static char* titolo2[] = { "Do you want to disable SCHED_MC?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo2, scelta, 0, 0);
			...
			case 1:
			{
				if((test=fopen("/data/neak/aftridle", "r"))==NULL)
				{
					static char* titolo1[] = { "Do you want to enable AFTR Idle Mode?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo1, scelta, 0, 0);
				...
				{
					static char* titolo2[] = { "Do you want to disable AFTR Idle Mode?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo2, scelta, 0, 0);
			...
			case 2:
			{
				if((test=fopen("/data/neak/ext4boost", "r"))==NULL)
				{
					static char* titolo1[] = { "Do you want to enable EXT4 Tweaks?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo1, scelta, 0, 0);
				...
				{
					static char* titolo2[] = { "Do you want to disable EXT4 Tweaks?",
												"",
												NULL
											 };
					int scelto = get_menu_selection(titolo2, scelta, 0, 0);
...
void show_neak_menu()
{
	...
	if((test2=opendir("/data/neak"))==NULL)
		mkdir("/data/neak", S_IRWXU | S_IRWXG | S_IRWXO);
...
void show_neak_config_menu()
{
	...
	static char* list[] = { "Remove CPU Freq Settings",
                            "Remove CPU Voltage Settings",
                            "Remove GPU Settings",
                            "Remove Misc Settings",
                            "Clear NEAK Options folder",
                             NULL
						  };
	...
	for (;;)
	{
		...
		switch (chosen_item)
		{
			case 0:
			{
				remove("/system/etc/init.d/S40neakCPU");
				ui_print("CPU freq script removed\n");
				break;
			}
			case 1:
			{
				remove("/system/etc/init.d/S42neakVoltage");
				ui_print("CPU Voltage script removed\n");
				break;
			}
			case 2:
			{
				remove("/system/etc/init.d/S41neakGPU");
				ui_print("GPU script removed\n");
				break;
			}
			case 3:
			{
				remove("/system/etc/init.d/S43neakMisc");
				ui_print("Misc script removed\n");
				break;
			}
			case 4:
			{
				__system("rm -rf /data/neak");
				__system("mkdir /data/neak");
				ui_print("NEAK Folder cleared\n");
				break;
			}
		}
	}
